...
export default function LoginView({ onLogin }: LoginViewProps) {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-gray-50 px-4 font-sans">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-gray-100 p-8 flex flex-col items-center text-center gap-8">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-gray-400 mt-1">イベント特化型 プロジェクト管理ツール</p>
          </div>
        </div>
